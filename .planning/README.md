...
120 documents and counting, which is past the point where `ls` is a
...
- [`tm-e-scenario-playbook-result.md`](tm-e-scenario-playbook-result.md) — Trade Management Task E — result: the response axis measured, and nothing survives the date
...
- [`rd-g-stage2-specification.md`](rd-g-stage2-specification.md) — Research Direction Task G — the stage-2 specification, fixed before it runs
- [`rd-h-stage2-result.md`](rd-h-stage2-result.md) — Research Direction Task H — stage 2 result: zero of twelve, and the one that looked real was the placebo
...
- [`rd-l-what-it-would-cost-to-know.md`](rd-l-what-it-would-cost-to-know.md) — Research Direction Task L — what it would cost to know: 3 of 12 are already answered, and the instrument was under-dispersed
